...
\tcProceeding
	\begin{enumerate}
	\item Mit NPM verwaltete Abhängigkeiten bauen mit \texttt{npm build}
	\item Mit Bower verwaltete Abhängigkeiten bauen mit \texttt{bower build}
...
\tcGoal
	\begin{enumerate}
	\item NPM build ohne fatale errors
	\item Bower build ohne fatale errors
	\item Grunt build ohne fatale errors
	\end{enumerate}
\end{testcase}
