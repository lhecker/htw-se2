...
\paragraph{}Fahrstuhl-Algorithmus\footnote{\url{https://de.wikipedia.org/wiki/Aufzugsanlage#Sammelsteuerung} oder \url{https://en.wikipedia.org/wiki/Elevator#The_elevator_algorithm}}
\todo{Unseren implementierten Algorithmus beschreiben}
