...
\begin{figure}[h]
	...
	\caption{Zustandsdiagram der Fahrstuhlsteuerung. Die im Diagramm verwendeten Abkürzungen erklären sich folgendermaßen: \textit{W}: Wunsch, \textit{R}: Ruf, \textit{ES}: Etagensensor, \textit{E}: Etage, \textit{WS}: WeightSensor oder Gewichtssensor, \textit{H}: History-Zustand}
	\label{ZD}
\end{figure}

Erläuterung zu ZD \todo{ZD in prosa beschreiben}
