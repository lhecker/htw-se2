...
Der Prozess, welcher letztlich zur vorliegenden Gestaltung der Benutzerschnittstelle führt, verlief ähnlich dem des Zustandsdiagramms. Über mehrere Treffen hinweg wurden Vorschläge gesammelt, diskutiert und letztlich auch der Kundin unterbreitet. Ein Zwischenstadium dieses Prozesses zeigt Abbildung \ref{Entwurf_UI}.
...
\item Konventionen Quelltext
	...
	\item Javascript:
		...
		\item Einrückungstil Variante 1TBS\footnote{\url{https://en.wikipedia.org/wiki/Indent_style#Variant:_1TBS}}
		\end{itemize}
	\end{itemize}
\end{itemize}
