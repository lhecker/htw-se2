...
Der \texttt{ElevatorDoorSensor} registriert sich beim \texttt{Elevator} nun außerdem in seinem Konstruktur für eben jenes Event, setzt seinen \texttt{\_remainOpen}-Member entsprechend und ruft die \textt{open}-Methode auf.
...
die Türen der ElevatorCarView öffnend, bzw. schließend zu animieren
